...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'wtf-time.com'
  config.app_name = 'Wtf_time'
  config.mailer.from = 'Wtf_time <no-reply@wtf-time.com>'
  ...
  #
  config.app_secret = 'U_7zjWHEWl0ES6owIO-RGZB8AMIfq0od9mIB6xX0G-NJwHo2QBiatWVkSEHMKYnB108'
